...
real_type ClothoidCurve::closest_point_by_sample( real_type const ds, real_type const qx,
...
static bool closest_point_QC2( real_type const epsi, ClothoidData const& CD, real_type const L,
    real_type const qx, real_type const qy, real_type& S )
{
    // S = GUESS
    integer nb{ 0 };
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
static real_type closest_point_QC1( real_type const epsi, ClothoidData const& CD, real_type const L,
    real_type const qx, real_type const qy, real_type& X, real_type& Y, real_type& S )
{
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
static real_type closest_point_QC( real_type const epsi, ClothoidData const& CD, real_type const L,
    real_type const qx, real_type const qy, real_type& X, real_type& Y, real_type& S )
{
    real_type const DTheta{ abs( CD.theta( L ) - CD.m_theta0 ) };
    if ( DTheta <= Utils::m_2pi ) return closest_point_QC1( epsi, CD, L, qx, qy, X, Y, S );
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
static bool closest_point_standard3( real_type const epsi, real_type const a, real_type const b,
    real_type const qx, real_type const qy, real_type& S )
{
    // S = GUESS
    integer nb{ 0 };
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
static real_type closest_point_standard2( real_type const epsi, real_type const a,
    real_type const b, real_type const qx, real_type const qy, real_type& S )
{
    real_type dx, dy;
    FresnelCS( a, dx, dy );
    dx -= qx;
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
static real_type closest_point_standard( real_type const epsi, ClothoidData const& CD,
    real_type const L, real_type const qx, real_type const qy, real_type& S )
{
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
static real_type closest_point1( real_type const epsi, ClothoidData const& CD, real_type const L,
    real_type const qx, real_type const qy, real_type& X, real_type& Y, real_type& S )
{
    constexpr real_type NT{
        4 }; // number of turn of the clothid after wich is considered quasi-circular
...
integer ClothoidCurve::closest_point_ISO( real_type const qx, real_type const qy, real_type& X,
