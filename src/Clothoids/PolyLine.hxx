...
class PolyLine : public BaseCurve {
  ...
  public:
    ...
    explicit PolyLine( string_view const name ) : BaseCurve( name )
    {
    ...
    void bbox_ISO( real_type /* offs */, real_type& /* xmin */, real_type& /* ymin */,
    ...
    //!
    integer closest_point_ISO( real_type x, real_type y, real_type& X, real_type& Y, real_type& S,
    ...
    //!
    void intersect_ISO(
        real_type offs, PolyLine const& pl, real_type offs_pl, IntersectList& ilist ) const;
