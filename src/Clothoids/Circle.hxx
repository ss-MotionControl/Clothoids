...
#include "BaseCurve_using.hxx"
    ...
    //!
    explicit CircleArc(
        real_type x0, real_type y0, real_type theta0, real_type k, real_type L, string_view name )
        : BaseCurve( name )
        , m_x0( x0 )
        , m_y0( y0 )
        , m_theta0( theta0 )
    ...
    //! \return true if success
    //!
    bool bbTriangle( real_type& x0, real_type& y0, real_type& x1, real_type& y1, real_type& x2,
        real_type& y2 ) const;
    ...
    //! \return true if success
    //!
    bool bbTriangle_ISO( real_type offs, real_type& x0, real_type& y0, real_type& x1, real_type& y1,
    ...
    //! \return true if success
    //!
    bool bbTriangle_SAE( real_type offs, real_type& x0, real_type& y0, real_type& x1, real_type& y1,
        real_type& x2, real_type& y2 ) const
    {
    ...
    //! \return true if success
    //!
    bool bbTriangle_ISO( real_type offs, Triangle2D& t, real_type ss0 = 0, real_type ss1 = 0,
    ...
    //! \return true if success
    //!
    bool bbTriangle_SAE( real_type offs, Triangle2D& t, real_type ss0 = 0, real_type ss1 = 0,
        integer icurve = 0 ) const
    {
    ...
    void evaluate( real_type const s, real_type& th, real_type& kappa, real_type& x,
    ...
    //!
    void intersect_ISO(
        real_type offs, CircleArc const& C, real_type offs_obj, IntersectList& ilist ) const;
    ...
    //!
    [[nodiscard]] real_type sin_theta0() const
    {
        return sin( m_theta0 );
    }
    ...
    //! \f$ \theta_0 \f$ is the initial tangent angle.
    //!
    [[nodiscard]] real_type cos_theta0() const
    {
        return cos( m_theta0 );
    }
    ...
    //!
    [[nodiscard]] real_type curvature() const
    {
        return m_k;
    }
    ...
    //!
    [[nodiscard]] real_type theta_total_variation() const
    {
        return delta_theta();
    }
    ...
    //!
    [[nodiscard]] real_type ray() const
    {
        return 1 / std::abs( m_k );
    }
