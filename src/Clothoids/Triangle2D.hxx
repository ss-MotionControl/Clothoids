...
class Triangle2D {
  ...
  public:
    ...
    Triangle2D( real_type x1, real_type y1, real_type x2, real_type y2, real_type x3, real_type y3,
        real_type s0, real_type s1, integer icurve )
    {
        m_p1[0] = x1;
        m_p1[1] = y1;
        m_p2[0] = x2;
    ...
    Triangle2D( real_type const p1[2], real_type const p2[2], real_type const p3[2], real_type s0,
        real_type s1, integer icurve )
    {
        m_p1[0] = p1[0];
        m_p1[1] = p1[1];
        m_p2[0] = p2[0];
    ...
    void build( real_type const p1[2], real_type const p2[2], real_type const p3[2], real_type s0,
        real_type s1, integer icurve )
    {
        m_p1[0] = p1[0];
        m_p1[1] = p1[1];
    ...
    void build( real_type x1, real_type y1, real_type x2, real_type y2, real_type x3, real_type y3,
        real_type s0, real_type s1, integer icurve )
    {
        m_p1[0] = x1;
        m_p1[1] = y1;
    ...
    {
        return ( m_p1[0] + m_p2[0] + m_p3[0] ) / 3;
    }
    real_type baricenter_y() const
    {
        return ( m_p1[1] + m_p2[1] + m_p3[1] ) / 3;
    }
