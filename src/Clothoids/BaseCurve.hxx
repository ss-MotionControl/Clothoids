...
//!
bool collision_ISO(
    BaseCurve const* pC1, real_type offs_C1, BaseCurve const* pC2, real_type offs_C2 );
...
//! \param[out] ilist   list of the intersection (as parameter on the curves)
//!
void intersect_ISO( BaseCurve const* pC1, real_type offs_C1, BaseCurve const* pC2,
    real_type offs_C2, IntersectList& ilist );
...
//! \param[out] ilist   list of the intersection (as parameter on the curves)
//!
inline void intersect_SAE( BaseCurve const* pC1, real_type offs_C1, BaseCurve const* pC2,
    real_type offs_C2, IntersectList& ilist )
{
...
//! \param[out] ilist   list of the intersection (as parameter on the curves)
//!
inline void intersect( BaseCurve const* pC1, real_type offs_C1, BaseCurve const* pC2,
    real_type offs_C2, IntersectList& ilist )
{
    if ( G2lib::use_ISO )
        G2lib::intersect_ISO( pC1, offs_C1, pC2, offs_C2, ilist );
...
class BaseCurve {
  ...
  public:
    ...
    //!
    virtual void bbox(
        real_type& xmin, real_type& ymin, real_type& xmax, real_type& ymax ) const = 0;
    ...
    //! \param[out] ymax right top
    //!
    virtual void bbox_ISO( real_type offs, real_type& xmin, real_type& ymin, real_type& xmax,
    ...
    //!
    virtual void bb_triangles( vector<Triangle2D>& tvec, real_type max_angle = Utils::m_pi / 18,
        real_type max_size = 1e100, integer icurve = 0 ) const = 0;
    ...
    //! \param[out] icurve    index of the covering triangles
    //!
    virtual void bb_triangles_ISO( real_type offs, vector<Triangle2D>& tvec,
    ...
    //! \param[out] icurve    index of the covering triangles
    //!
    virtual void bb_triangles_SAE( real_type offs, vector<Triangle2D>& tvec,
        real_type max_angle = Utils::m_pi / 18, real_type max_size = 1e100,
        integer icurve = 0 ) const = 0;
    ...
    {
        return this->X_ISO( this->length(), offs );
    }
    ...
    {
        return this->Y_ISO( this->length(), offs );
    }
    ...
    //!
    //! \f$x\f$-coordinate second derivative at curvilinear coordinate \f$s\f$ with offset `offs`
    //! (ISO).
    //!
    virtual real_type X_ISO_DD( real_type s, real_type offs ) const;

    //!
    //! \f$y\f$-coordinate second derivative at curvilinear coordinate \f$s\f$ with offset `offs`
    //! (ISO).
    //!
    virtual real_type Y_ISO_DD( real_type s, real_type offs ) const;

    //!
    //! \f$x\f$-coordinate third derivative at curvilinear coordinate \f$s\f$ with offset `offs`
    //! (ISO).
    //!
    virtual real_type X_ISO_DDD( real_type s, real_type offs ) const;

    //!
    //! \f$y\f$-coordinate third derivative at curvilinear coordinate \f$s\f$ with offset `offs`
    //! (ISO).
    //!
    ...
    //!
    virtual void eval_ISO_DDD(
        real_type s, real_type offs, real_type& x_DDD, real_type& y_DDD ) const;
    ...
    virtual void intersect_ISO(
        real_type offs, BaseCurve const* pC, real_type offs_C, IntersectList& ilist ) const = 0;
    ...
    //!
    void intersect_SAE(
        real_type offs, BaseCurve const* pC, real_type offs_C, IntersectList& ilist ) const
    {
    ...
    //!
    virtual integer closest_point_ISO( real_type qx, real_type qy, real_type& x, real_type& y,
        real_type& s, real_type& t, real_type& dst ) const = 0;
    ...
    //!        -1 = minimum point is not othogonal projection to curve
    //!
    integer closest_point_SAE( real_type qx, real_type qy, real_type& x, real_type& y, real_type& s,
    ...
    closest_point_ISO( real_type qx, real_type qy, real_type offs, real_type& x, real_type& y,
        real_type& s, real_type& t, real_type& dst ) const = 0;
    ...
    //!        -1 = minimum point is not othogonal projection to curve
    //!
    integer closest_point_SAE( real_type qx, real_type qy, real_type offs, real_type& x,
