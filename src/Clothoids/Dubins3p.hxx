...
namespace G2lib
{
  ...
  */
  ...
  public:
    ...
    //!
    Dubins3p( Dubins3p const & s ) : BaseCurve( s.name() ) { this->copy( s ); }
    ...
    //!
    [[nodiscard]]
    bool collision_ISO( real_type const offs, Dubins3p const & B, real_type const offs_B ) const;
    ...
    //! \param[out] ilist  list of the intersection (as parameter on the curves)
    //!
    void intersect_ISO( real_type const offs, Dubins3p const & B, real_type const offs_B, IntersectList & ilist ) const;
