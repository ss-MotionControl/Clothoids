...
bool Dubins_build( real_type x0, real_type y0, real_type theta0, real_type x1, real_type y1,
    real_type theta1, real_type k_max, DubinsType& type, real_type& L1, real_type& L2,
    real_type& L3, real_type grad[2] );
...
class Dubins : public BaseCurve {
  ...
  public:
    ...
    //!
    explicit Dubins( real_type x0, real_type y0, real_type theta0, real_type x1, real_type y1,
        real_type theta1, real_type k_max, string_view name );
    ...
    //!
    [[nodiscard]]
    bool build( real_type x0, real_type y0, real_type theta0, real_type x1, real_type y1,
        real_type theta1, real_type k_max );
    ...
    //!
    integer get_range_angles_begin( real_type x0, real_type y0, real_type x1, real_type y1,
        real_type theta1, real_type k_max, real_type angles[] ) const;
    ...
    //! \return     number of range points
    //!
    integer get_range_angles_end( real_type x0, real_type y0, real_type theta0, real_type x1,
        real_type y1, real_type k_max, real_type angles[] ) const;
    ...
    [[nodiscard]] real_type length_Dalpha() const
    {
        return m_length_Dalpha;
    }
    [[nodiscard]] real_type length_Dbeta() const
    {
        return m_length_Dbeta;
    }
    ...
    [[nodiscard]] DubinsType solution_type() const
    {
    ...
    {
        return to_integer( m_solution_type );
    }
    ...
    {
        return m_C0.kappa_begin();
    }
    [[nodiscard]] real_type kappa1() const
    {
        return m_C1.kappa_begin();
    }
    [[nodiscard]] real_type kappa2() const
    {
        return m_C2.kappa_begin();
    }
    ...
    {
        return m_C0.theta_begin();
    }
    [[nodiscard]] real_type theta_end() const override
    {
        return m_C2.theta_end();
    }
    ...
    void bb_triangles( vector<Triangle2D>& tvec, real_type max_angle = Utils::m_pi / 18,
    ...
    //!
    void intersect_ISO(
        real_type offs, Dubins const& B, real_type offs_B, IntersectList& ilist ) const;
