...
#include "BaseCurve_using.hxx"
    ...
    explicit LineSegment(
        real_type x0, real_type y0, real_type theta0, real_type L, string_view name )
        : BaseCurve( name )
        , m_x0( x0 )
        , m_y0( y0 )
        , m_theta0( theta0 )
    ...
    [[nodiscard]] real_type length_ISO( real_type ) const override
    {
        return m_L;
    }
    ...
    {
        return m_x0 + m_L * m_c0;
    }
    [[nodiscard]] real_type y_end() const override
    {
        return m_y0 + m_L * m_s0;
    }

    [[nodiscard]] real_type x_begin_ISO( real_type const offs ) const override
    {
        return m_x0 + offs * nx_begin_ISO();
    }
    [[nodiscard]] real_type y_begin_ISO( real_type const offs ) const override
    {
        return m_y0 + offs * ny_begin_ISO();
    }
    [[nodiscard]] real_type x_end_ISO( real_type const offs ) const override
    {
        return x_end() + offs * nx_begin_ISO();
    }
    [[nodiscard]] real_type y_end_ISO( real_type const offs ) const override
    {
    ...
    [[nodiscard]] real_type tx( real_type ) const override
    {
        return m_c0;
    }
    [[nodiscard]] real_type ty( real_type ) const override
    {
        return m_s0;
    }
    [[nodiscard]] real_type tx_D( real_type ) const override
    {
        return 0;
    }
    [[nodiscard]] real_type ty_D( real_type ) const override
    {
        return 0;
    }
    [[nodiscard]] real_type tx_DD( real_type ) const override
    {
        return 0;
    }
    [[nodiscard]] real_type ty_DD( real_type ) const override
    {
        return 0;
    }
    [[nodiscard]] real_type tx_DDD( real_type ) const override
    {
        return 0;
    }
    [[nodiscard]] real_type ty_DDD( real_type ) const override
    {
        return 0;
    }
    ...
    [[nodiscard]] real_type X_ISO_D( real_type, real_type ) const override
    {
        return m_c0;
    }
    [[nodiscard]] real_type Y_ISO_D( real_type, real_type ) const override
    {
        return m_s0;
    }
    [[nodiscard]] real_type X_ISO_DD( real_type, real_type ) const override
    {
        return 0;
    }
    [[nodiscard]] real_type Y_ISO_DD( real_type, real_type ) const override
    {
        return 0;
    }
    [[nodiscard]] real_type X_ISO_DDD( real_type, real_type ) const override
    {
        return 0;
    }
    [[nodiscard]] real_type Y_ISO_DDD( real_type, real_type ) const override
    {
        return 0;
    }
    ...
    void eval_ISO(
        real_type const s, real_type const offs, real_type& x, real_type& y ) const override
    {
    ...
    */
    ...
    [[nodiscard]]
    bool intersect_ISO( real_type offs, LineSegment const& S, real_type S_offs, real_type& s1,
        real_type& s2 ) const;

    void intersect( LineSegment const& LS, IntersectList& ilist ) const;

    void intersect_ISO(
        real_type offs, LineSegment const& LS, real_type offs_LS, IntersectList& ilist ) const;
