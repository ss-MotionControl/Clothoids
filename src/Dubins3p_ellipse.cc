...
bool Dubins3p::build_ellipse( real_type xi, real_type yi, real_type thetai, real_type xm,
    real_type ym, real_type xf, real_type yf, real_type thetaf, real_type k_max )
{
    ...
    auto eval3p = [this, xi, yi, thetai, xm, ym, xf, yf, thetaf, k_max](
                      Dubins3p_data& D3P ) -> void {
