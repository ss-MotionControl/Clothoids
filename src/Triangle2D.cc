...
static bool intersection_test_vertex( real_type const P1[2], real_type const Q1[2],
    real_type const R1[2],
    // - - - - - - - - - -
    real_type const P2[2], real_type const Q2[2], real_type const R2[2] )
{
    if ( orient_2d( R2, P2, Q1 ) >= 0 ) {
        ...
        return orient_2d( P1, Q2, Q1 ) <= 0 && orient_2d( R2, Q2, R1 ) <= 0 &&
...
static bool intersection_test_edge( real_type const P1[2], real_type const Q1[2],
    real_type const R1[2], real_type const P2[2], real_type const R2[2] )
{
    if ( orient_2d( R2, P2, Q1 ) >= 0 ) {
        if ( orient_2d( P1, P2, Q1 ) >= 0 ) {
...
static bool tri_tri_intersection_2d( real_type const p1[2], real_type const q1[2],
    real_type const r1[2], real_type const p2[2], real_type const q2[2], real_type const r2[2] )
{
...
static bool tri_tri_overlap_test_2d( real_type const p1[2], real_type const q1[2],
    real_type const r1[2], real_type const p2[2], real_type const q2[2], real_type const r2[2] )
{
...
static real_type distSeg(
    real_type const x, real_type const y, real_type const A[], real_type const B[] )
{
